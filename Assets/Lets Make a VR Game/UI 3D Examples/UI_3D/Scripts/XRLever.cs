...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRLever : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("The object to display when the lever angle is greater than 39 degrees")]
        ...
        void UpdateValue()
        {
            ...
            if (leverAudioSource != null && !leverAudioSource.isPlaying)
            {
                leverAudioSource.Play(); // تشغيل الصوت
            }

            // إظهار الكائن إذا كانت الزاوية أكبر من 39 درجة
            if (lookAngle <38)
            {
        ...
        void SetValue(bool isOn, bool forceRotation = false)
        {
            ...
            if (leverAudioSource != null && !leverAudioSource.isPlaying)
            {
                leverAudioSource.Play(); // تشغيل الصوت هنا أيضًا إذا كنت تريد
            }
